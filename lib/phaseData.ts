...
export const PHASE_DATA: PhaseInfo[] = [
  ...
  },
  {
    ...
    description: "A bespoke double-decker steel cage rises from the frame. Individual sleeper pods are fitted with premium upholstery. Theatre floors. Everything designed for the passenger.",
    specs: [
